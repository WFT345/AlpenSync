...
// path core/storage/src/main/kotlin/io/pcontacts/core/storage/InMemorySecretStore.kt

package app.alpensync.core.auth.store

/**
 * Test-only [SecretStore]. Orchestrator and HTTP-layer tests use this in
 * place of [EncryptedSecretStore] so they stay pure-JVM (no Robolectric /
 * no emulator).
 *
 * Not thread-safe by intent — wrap with synchronization at the boundary if
 * a test scenario needs concurrent access.
 */
